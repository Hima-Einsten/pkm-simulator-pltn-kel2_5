/*
 * ESP-F I2C Slave - Visualizer Aliran Sekunder
 * 
 * I2C Slave Address: 0x0B
 * 
 * Receives from Raspberry Pi:
 * - Pressure (float, 4 bytes)
 * - Pump Status (uint8, 1 byte) - Secondary pump status
 * Total: 5 bytes
 * 
...
void setup() {
    Serial.begin(115200);
    Serial.println("ESP-F (Secondary Flow Visualizer) I2C Slave Starting...");
